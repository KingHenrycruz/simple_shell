...
/**
 * strjoin - Two strings being joined
 * @n: mem add to store str
 * @sep: joining string
 * @pre: Begining string
 * @suf: Ending string
 * Return: A pointer to the next str
 */
...
/**
 * strjoina - strings joined from a NULL array
 * @n: mem add to store str
 * @sep: String joiner
...
/**
 * strjoinl - joins char with NULL terminated str
 * @n: mem add to store str
 * @sep: String joiner
 * @...: rep the strings
 * Return: A pointer to the next str
