...
/**
 * struct buf_s - inserted buffer
 * @buffer: existing buffer
 * @next: pointed next value
 * @remaining:remaining output values
 */
...
/**
 * struct buf_table_node_s - hash table buffer results
 * @fd: file lable
 * @buf: connected buffer
 * @next: The following buffer chain
 */
